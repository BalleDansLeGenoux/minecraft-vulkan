...
const std::vector<Vertex> vertices = {
    ...
    {{0.5f, -0.5f, 0.5f}, {0.0f, 1.0f, 0.0f}, {1.0f/16, 0.0f}},
    {{0.5f, 0.5f, 0.5f}, {0.0f, 0.0f, 1.0f}, {1.0f/16, 1.0f/16}},
    {{-0.5f, 0.5f, 0.5f}, {1.0f, 1.0f, 1.0f}, {0.0f, 1.0f/16}},

    {{-0.5f, 0.5f, 0.5f}, {1.0f, 0.0f, 0.0f},  {(1.0f/16)*3, 0.0f/1}},
    {{0.5f, 0.5f, 0.5f}, {0.0f, 1.0f, 0.0f},   {(1.0f/16)*4, 0.0f/1}},
    {{0.5f, 0.5f, -0.5f}, {0.0f, 0.0f, 1.0f},  {(1.0f/16)*4, 1.0f/16}},
    {{-0.5f, 0.5f, -0.5f}, {1.0f, 1.0f, 1.0f}, {(1.0f/16)*3, 1.0f/16}},
